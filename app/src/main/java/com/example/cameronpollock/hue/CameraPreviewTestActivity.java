...
package com.example.cameronpollock.hue;
...
public class CameraPreviewTestActivity extends Activity implements AdapterView.OnItemSelectedListener {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        Log.w("CameraPreviewTestActiv", "onItemSelected invoked");
        Log.w("CameraPreviewTestActiv", "position: " + position);
        Log.w("CameraPreviewTestActiv", "parent.getId(): " + parent.getId());
        switch (parent.getId()) {
